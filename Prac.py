...
def crawl_kakao_webtoon(driver1, title, kw):
    ...
    genre_temp['이름'] = [title]
    genre_temp['장르'] = [driver1.current_url]
...
def crawl_kakao_page(driver2, title, kp):
    ...
    week_temp['이름'] = [title]
    week_temp['요일'] = [driver2.current_url]
...
def crawl_naver_series(driver3, title, nv):
    ...
    keyword_temp['키워드'] = [driver3.current_url]
...
def crawl_lezhin_comics(driver4, title, lz):
    ...
    plot_temp['이름'] = [title]
    plot_temp['줄거리'] = [driver4.current_url]
